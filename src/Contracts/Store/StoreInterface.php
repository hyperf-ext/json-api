 ...
 */
namespace HyperfExt\JsonApi\Contracts\Store;
...
interface StoreInterface
{
     ...
     *
     * @param object $record the domain record being read
     * @return null|object
     */
     ...
     *
     * @param object $record the domain record to update
     * @param array $document the JSON API document received from the client
     * @return object
     ...
     * @param encodingParametersInterface $params the encoding parameters to use for the query
     * @return mixed
     *               the related records
     */
     ...
     *
     * @param object $record the object to hydrate
     ...
     * @param $relationshipKey
     * @param array $document the JSON API document received from the client
     * @throws runtimeException if the relationship object is a has-one relationship
     * @return object
     *                the updated domain record
     */
     ...
     * @return null|mixed the record, or null if it does not exist
     */
     ...
     *
     * @return null|mixed the domain record or null
     */
     ...
     *
     * @return iterable containing the related domain records
     */
     ...
     * @return iterable the domain records that match the supplied identifiers
     */
     ...
     *
     * @param mixed|string $resourceType the resource type (string), or the domain record (object)
