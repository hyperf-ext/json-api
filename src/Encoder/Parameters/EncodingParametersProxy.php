...
class EncodingParametersProxy implements EncodingParametersInterface, Arrayable
{
    ...
    protected function getInstance(): EncodingParametersInterface
    {
        return Context::get(EncodingParametersInterface::class);
    }
}
