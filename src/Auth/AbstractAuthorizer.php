...
abstract class AbstractAuthorizer implements AuthorizerInterface
{
    ...
    public function readRelationship($record, string $field, ServerRequestInterface $request)
    {
        $this->read($record, $request);
    }

    public function modifyRelationship($record, string $field, ServerRequestInterface $request)
    {
